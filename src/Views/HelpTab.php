		...
		$screen->add_help_tab(
			[
				...
				'callback' => function() {
					...
					<p>На сегодняшний день <?php echo esc_html( date( 'd.m.Y' ) ); ?> официально технологию поддерживают только <i>Яндекс</i>, <i>Bing</i> и сам официальный сайт <i>indexnow.org</i>, остальные поисковые системы пока морозятся.</p>
					<?php
				},
			]
		);
